...
export function SidebarLinks(props: {
  ...
  let activeColor = useColorModeValue('secondaryGray.600', 'white');
          ...
          <Accordion allowToggle key={key}>
            <AccordionItem maxW="100%" border="none" key={key}>
              <AccordionButton
                ...
                _hover={{
                  bg: activeRoute(route.path.toLowerCase()) ? 'linear-gradient(45deg, #ffffff3d, transparent)' : 'unset'
                }}
                _focus={{
                  boxShadow: 'none',
                }}
                ...
                ms={0}
                mb={'10px'}
                background={ activeRoute(route.path.toLowerCase()) ? 'linear-gradient(45deg, #ffffff3d, transparent)' : 'unset'}
              >
                {route.icon ? (
                  <Flex
                    align="center"
...
//                justifyContent="space-between"
              ...
              >
                ...
                >
                  <Flex w="100%" alignItems="center" justifyContent="center" padding={'5px'}>
                    <Box
                      color={
                        activeRoute(route.path.toLowerCase())
                          ? activeIcon
