...
import { getGameCreatorDemoData, getAnimations } from 'utils/game/gameService';
import {
  getBackgrounds,
  getAssignedGame,
} from 'utils/gameApplication/gamePlayService';
...
const GamePreview = () => {
  ...
  useEffect(() => {
    learner_game_play_id && fetchCreatorDemoData();
  ...
  const fetchCreatorDemoData = async () => {
    ...
    let gameId = learner_game_play_id;
    const gamedata = await getGameCreatorDemoData(gameId, ctId);
