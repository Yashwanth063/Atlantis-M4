...
import { activityCreate, activitygetlastblock, getGameActId } from "utils/gameApplication/gameActivityService";
...
// console.log("progressforBadgeInpercent",progressforBadgeInpercent)
   ...
   console.log("profile-in-chapters",profile,"queststate",questState)
    return (
      <>
        <Box
          position="relative"
