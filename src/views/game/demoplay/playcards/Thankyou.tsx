...
import { insertGameFedback } from '../../../../utils/game/gameService';
...
const ThankYou: React.FC<{
  ...
  const handleOptionClick = (value: any, category: any) => {
    // if (userInputs[category]) return; // Prevent further selection if already set
    if (userInputs[category] === value) {
      if (
        userInputs?.gameContent ===
          learnerPlayList?.playerInputs?.Thankyou?.gameContent ||
        userInputs?.gameRelevance ===
          learnerPlayList?.playerInputs?.Thankyou?.gameRelevance ||
        userInputs?.gameBehaviour ===
          learnerPlayList?.playerInputs?.Thankyou?.gameBehaviour ||
        userInputs?.gameGamification ===
          learnerPlayList?.playerInputs?.Thankyou?.gameGamification ||
        userInputs?.gameRecommendation ===
          learnerPlayList?.playerInputs?.Thankyou?.gameRecommendation
      ) {
  ...
  const handleOtherFeedbackChange = (value: string, category: string) => {
    setUserInputs((prevInputs: any) => ({
      ...prevInputs,
      [category]: value, // Update the specific feedback category
    }));
    setLearnerPlayingDetails((prev: any) => ({
      ...prev,
      playerInputs: {
                          ...
                          >
                            ...
                            >
                              ...
                              >
                                ...
                                {(userInputs.gameContent ===
                                  'I learned something useful' ||
                                  learnerPlayList?.playerInputs?.Thankyou
                                    ?.gameContent ===
                                    'I learned something useful') && (
                                  <p>&#10004;</p>
                                )}
                          ...
                          >
                            ...
                            >
                              <div
                                ...
                                onClick={() =>
                                  handleOptionClick(
                                    'I understood what I can do differently',
                                    'gameBehaviour',
                                  )
                                }
                              >
                          ...
                          >
                            ...
                            >
                              <div
                                ...
                                onClick={() =>
                                  handleOptionClick(
                                    'I liked learning through this graphical theme',
                                    'gameGamification',
                                  )
                                }
                              >
                                <p>&#128077; I liked learning through this graphical theme</p>
                                {(userInputs.gameGamification ==
                                  'I liked learning through this graphical theme' ||
                                  learnerPlayList?.playerInputs?.Thankyou
                                    ?.gameGamification ==
