...
import futuristicOffice1 from '../../../../assets/glb/Futuristicoffice.glb';
...
const defaultModelsActivity = {
    ...
    useLayoutEffect(() => {
      ...
      rgbLoader
        .load(hdrFilePath, (texture) => {
          ...
          gltfLoader.load(preloadedAssets?.preloadedGLBs?.futuristicOffice?.src, (gltf) => {
  ...
  (gltf) => {
        ...
        model.scale.set(1.6, 1.5, 1.6);
        model.rotation.set(0, 2.1, 0);
        model.position.set(7.8, 0.1, 3.3);
        ...
        const light = new THREE.DirectionalLight(0xffffff, 1);
            light.position.set(0, 2, 1); // Position the light above the model
  ...
  if (selectedNPC) {
              ...
              gltfLoader.load(
                ...
                //         model.scale.set(1.2, 44.2, 1.2);
                //   model.rotation.set(0, 0.7, 0);           
                //   model.position.set(32.0, 25.7, 5.5);



                model.scale.set(1.6, 1.5, 1.2);
                model.rotation.set(0, -12.5, 0);
                model.position.set(8.1, 0.1, 1.9);
    ...
    // //   50.702,
      ...
      camera.position.set(10.949, 1.7168, 4.1948);
    //   camera.position.set(10.950, 1.717, 4.195);
      camera.rotation.set(0.2454, 1.2428, -0.2315);
...
if (sizes.height > sizes.width) [sizes.width, sizes.height] = [sizes.height, sizes.width];
 ...
 if (npcMixerRef.current && npcAnimationsRef.current) {
  ...
  FuturisticOffice.defaultProps = {
    modelsActivity: defaultModelsActivity,
  }
  export default React.memo(FuturisticOffice);