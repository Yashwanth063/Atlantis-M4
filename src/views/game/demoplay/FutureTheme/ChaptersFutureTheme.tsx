  ...
  const NavigationArrow: React.FC<{
    ...
    return (
      <Button
        ...
        size="sm"
        onClick={onClick}
        className="rounded-4xl h-[2.125rem] w-[3.125rem] px-4 py-2 transition-all duration-200 hover:scale-110"
        style={{
  ...
  return (
    ...
    >
      <div className="relative flex h-full w-full px-4 pb-4 sm:px-6 sm:pb-6 lg:px-8 lg:pb-8">
        ...
        {/* Quest Content */}
        <div className="flex-grow-1 flex h-full flex-col items-center justify-center pt-5">
          <div
            className="md2x:min-h-[34.5rem] md2x:max-w-[76rem] relative flex h-full max-h-fit w-full max-w-[92vw] flex-col items-center justify-start gap-5 rounded-3xl px-10 pb-4 pt-5"
            style={{
          ...
          >
            ...
            {/* Quest Cards Grid */}
            <div className="max-md2x:hidden w-full flex-1">
