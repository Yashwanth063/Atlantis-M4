...
import imgLogo from '../../../../assets/img/NewUI_Images/atlantis-logo.png';
import { Button } from "../../../../components/ui/button";

import { ScoreContext } from '../GamePreview';

import { useParams } from 'react-router-dom';
import { getBackgrounds, getAssignedGame } from '../../../../../src/utils/gameApplication/gamePlayService';
...
const AvatarAndTitle: React.FC = () => {
  ...
  return (
    <div className="box-border content-stretch flex flex-col gap-2 items-center justify-start p-0 relative shrink-0 w-full">
      <div className="bg-[#000000] box-border content-stretch flex flex-row gap-1.5 items-center justify-center p-3.5 relative rounded-full shrink-0">
        <div
        ...
        />
        <div
          className="bg-center bg-cover bg-no-repeat shrink-0 size-[6.092rem] rounded-full"
          data-name="image 99"
...
const WelcomeContent: React.FC<GameIntroType> = ({ preloadedAssets, setCurrentScreenId, currentScreenId, gameInfo, hasMulitLanguages, gameLanguages, profileData, setProfileData, isInitialLoadScreenWelcome, setIsInitialLoadScreenWelcome,setLearnerPlayingDetails,learnerPlayList,AssignId,setQuestState,setAssignId, UpdateLearnerData,setFeedbackList}) => {
 ...
 //****************************************************end New State for M4**************************************************************** */
  ...
  const handleProfile = (e: any, input?: any) => {
    ...
    setIsError((prevError:any) => ({ ...prevError, [id]: null }));
    setFormState((prev: any) => ({ ...prev, [id]: id === 'name' ? trimmedValue : input }));
  };
  return (
    <div className="relative shrink-0 w-full">
      <div className="flex flex-col items-center relative size-full">
        <div className="box-border content-stretch flex flex-col gap-9 items-center justify-start pb-11 pt-[1.433rem] px-[1.433rem] relative w-full">
          <div className="text-white text-4xl font-normal text-center text-nowrap tracking-[0.005rem]">
...
const GameIntroScreenFutureTheme: React.FC<GameIntroType> = ({
  preloadedAssets,
  setCurrentScreenId,
  currentScreenId,
  gameInfo,
  ...
  setQuestState,
  gameLanguages,
  isInitialLoadScreenWelcome,
  setIsInitialLoadScreenWelcome,
  profileData,
  setProfileData,
  learnerPlayList,
  ...
  return (
    ...
    >
      {/* Main Content */}
      <div className="h-full flex-grow-1 flex flex-col justify-center items-center z-10 relative">
        <div
          className="flex flex-col gap-5 max-h-[30.5rem] max-w-[46rem] overflow-hidden h-full w-full items-center justify-start rounded-[2.375rem] relative px-10 py-8 backdrop-filter backdrop-blur-[3.724rem]"
          style={{
        ...
        >
          ...
          {/* Main Content */}
          <div className="basis-0 box-border content-stretch flex flex-col gap-3 grow items-start justify-start min-h-px min-w-px p-0 relative shrink-0 z-10">
            <AvatarAndTitle />
            <WelcomeContent
...
export default GameIntroScreenFutureTheme;
