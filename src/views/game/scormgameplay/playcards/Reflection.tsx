...
import { scormstoreReflection } from 'utils/scormApplication/scormgamePlayService';
...
const ansValue = e.target.value;
    ...
    const nextNavigation = async() => {
      ...
      const result = await scormstoreReflection(JSON.stringify(data));
          ...
          <>
            <Box className="reflection-screen">
              ...
              <Box className="content-ref">
                {formData?.gameIsShowReflectionScreen === 'true' ? (
                  <>
                    {console.log("reflection", "...", "reflectionFilter", reflectionFilter)}
                    <Box className="content-ref">
