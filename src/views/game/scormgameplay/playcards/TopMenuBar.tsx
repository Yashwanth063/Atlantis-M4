...
import { getscormLeaderboardData } from 'utils/scormApplication/scormgamePlayService';
...
useEffect(() => {
 ...
 const  learnerid= learnerPlayList.playerId;
 
    useEffect(() => {
      const getAllLearnerScores = async () => {
         const  learnerid= learnerPlayList.playerId || scormDetails.scormLearnerId;
         console.log(learnerid,'learneridintopemnubar1')
         console.log(learnerPlayList,'learnerPlayListintopmenubar1')
         console.log(scormDetails.scormLearnerId,'scormDetails.scormLearnerId2')
         console.log(scormDetails,'scormDetailsintpromenubar2')
        const getLeaderboardDatas = await getscormLeaderboardData(learner_game_play_id,learnerid);
      ...
      getAllLearnerScores();
    }, [learner_game_play_id,learnerPlayList.playerId,scormDetails.scormLearnerId,scormDetails]);
    // useEffect(()=>{
    //   getAllLearnerSCores();
    // },[]);
useEffect(() => {
  ...
  const fetchLeaderboard = async () => {
     const  learnerid= learnerPlayList.playerId || scormDetails.scormLearnerId;
         console.log(learnerid,'learneridintopemnubar2')
         console.log(learnerPlayList,'learnerPlayListintopmenubar2')
         console.log(scormDetails.scormLearnerId,'scormDetails.scormLearnerId2')
         console.log(scormDetails,'scormDetailsintpromenubar2')
...
}, [learner_game_play_id, profile,,learnerPlayList.playerId,scormDetails.scormLearnerId,scormDetails]);
  ...
  //   if ([2, 4, 6, 8, 14].includes(currentScreenId)) {
  //     const scoreArray = profile?.score;
  ...
  //       }, 0);
  //     }
  //     if ([4, 6, 8,  14].includes(currentScreenId)) {
  ...
  // }, [profile?.score?.length,currentScreenId,profile?.score]);
