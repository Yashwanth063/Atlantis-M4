...
const Interaction: React.FC<InteractionProps> = ({
  ...
  useEffect(() => {
    ...
    if (RepeatSelectOption === true) {
      ...
      if (RepeatPrevOption.length > 0) {
        ...
        console.log("prevoptionseleted",prevoptionseleted)
        // return;
  ...
  // console.log("reapeatprevSelectOption",reapeatprevSelectOption)
   console.log("prevSelectOption",prevSelectOption)
                          ...
                          options.map((item: any, ind: number) => (
                            ...
                            >
                              ...
                              >
                                <Img
                                  src={
                                    reapeatprevSelectOption?.some((prev: any) => prev === item.qpOptions)
                                      ? preloadedAssets.on
                                      : prevSelectOption === item.qpOptions ? preloadedAssets.on : preloadedAssets.off
                                  }
                                  opacity={reapeatprevSelectOption?.some((prev: any) => prev === item.qpOptions) ? 0.5 : 1}
                                  h={'4vh'}
                                  w={'100%'}
                                />
                                <Box className={'story_interaction_option'} overflowWrap={'anywhere'}>
