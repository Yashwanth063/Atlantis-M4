...
const GameIntroScreen: React.FC<GameIntroType> = ({ preloadedAssets, setCurrentScreenId, currentScreenId, gameInfo, hasMulitLanguages, gameLanguages, profileData, setProfileData, isInitialLoadScreenWelcome, setIsInitialLoadScreenWelcome,setLearnerPlayingDetails,learnerPlayList,AssignId,setQuestState,setAssignId, UpdateLearnerData,setFeedbackList, scormDetails }) => {
  ...
  const Handlemodel = async () => {
    ...
    console.log(learnerid,'learneridingameintoscreen')
    ...
    if (result?.status === "Success") {
      ...
      const learnerPlayingDetails = result?.LearnerPlayinggame?.learnerGameplayDetails ? result?.LearnerPlayinggame?.learnerGameplayDetails: null;
      console.log(learnerPlayingDetails,'learnerPlayingDetailsingameintoscreen')
      if (!result?.LearnerPlayinggame?.learnerGameplayDetails) {
        UpdateLearnerData();
      }
      else {
        console.log('learnerPlayingDetails=>', learnerPlayingDetails);
