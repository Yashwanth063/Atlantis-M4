...
import {
  Box, Button, Flex, Heading, Icon, Img, SimpleGrid, Text, useColorModeValue, IconButton,
  InputGroup,
  ...
  return (
    <>
      <Box className="LearnerGames" position={'relative'} >
        <Box mb={{ base: '30px', xl: '30px' }} mt={{ base: '0px', md: '130px', xl: '100px' }} className="box">
          <Card backgroundImage={NFTBanner} backgroundRepeat={'no-repeat'} backgroundSize={'cover'} height={'300px'} width={'100%'} h={'auto'} mt={{ base: '0px', md: "87px" }}>
            <Box display={{ base: 'block', xl: 'flex' }} justifyContent="space-between" alignItems={'end'} padding={{ base: '0', xl: '20px' }}>
                ...
                >
                  ...
                  >
                    <Img
                      ...
                      position={'relative'}
                    />
                    {game?.status === 'not yet started' && <Badge
                      position="absolute"
                      top="0px"
                      left="0px"
                      variant="solid"
                  ...
                  <Flex justifyContent={'space-between'} margin={'10px 0'}>
                    <Box>
                      ...
                      {/* Afrith-modified-starts-25/July/24-Game SKills */}
                      ...
                      {/* Afrith-modified-ends-25/July/24-Game SKills */}
                      <Text
                        color={'#745c5cc9'}
                        mt={'5px'}
                        fontSize={'14px'}
