...
import { getMethod, postMethod, putMethod ,urls,postMethodfile,postMethodVoice,postMethodGameReview} from 'utils/scormurl/scormurl';
...
export async function track_Api(params) {
  try {
    const response = await fetch(`${API_SERVER}${urls.track_Api}`,getMethod);
    const result = await response.json(); 
    return result;
  } catch (err) {
    console.log('getCreator Error:', err);
...
export async function scormgetGameById(id) {
  try {
    const response = await fetch(`${API_SERVER}${urls.scormgetGameById}${id}`, getMethod);
    const result = await response.json();
    return result;
  } catch (err) {
    console.log('getCreator Error:', err);
...
export async function scormgetSkills() {
  try {
    const response = await fetch(`${API_SERVER}${urls.scormgetSkills}`,getMethod);
    const result = await response.json(); 
    return result;
  } catch (err) {
    console.log('getCreator Error:', err);
...
export async function scormgetSkillsName(gameId) {
  console.log(gameId,'gameidinskilsname')
  try {
    const response = await fetch(`${API_SERVER}${urls.scormgetSkillsName}/${gameId}`, getMethod);
    const result = await response.json();
    return result;
  } catch (err) {
    console.log('getCreator Error:', err);
...
export async function getScormGameDemoData(id, learnerId) {
  try {
    const response = await fetch(`${API_SERVER}${urls.getScormGameDemoData}${id}/${learnerId}`,getMethod);
    const result = await response.json(); 
    return result;
  } catch (err) {
    console.log('getCreator Error:', err);
...
export async function scorminsertGameFedback(id, data) {
  try {
    const response = await fetch(`${API_SERVER}${urls.scorminsertGameFedback}/${id}`, postMethod(data));
    const result = await response.json(); 
    return result;
  } catch (err) {
    console.log('getCreator Error:', err);
