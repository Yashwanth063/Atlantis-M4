...
/*********************SCORM API Call ******************************/
getScormGameDemoData: '/scormgame/scorm/demo/',
getAnimations:'/scormgamePlay/getAnimations',
scormactivityCreate: '/scormgameactivity/create',
scormactivityUpdate: '/scormgameactivity/update/',
  scormgetTimespent: '/scormgameactivity/scormgetTimespent',
scormcreateGamePlayHistory:'/scormgameactivity/createGamePlayHistory',
gameLanguages: '/languages/getGameLanguages/',
getContentRelatedLanguage: '/languages/getContentRelatedLanguage/',
scormupdateLearnerDetails: '/scormgamePlay/updateLearnerDetails',
scormgetGameById: '/scormgame/getGameById/',
scormgetSkills: '/skills/getSkills',
scormgetSkillsName: '/scormgame/getSkillsName',
scormupdateLearnerNickName: '/scormgamePlay/updateLearnerNickName',
scormactivitygetlastblock:'/scormgameactivity/getLastBlock',
scormstoreReflection:'/scormreflectionquestion/storeanswer',
scorminsertGameFedback:'/scormgamePlay/insertGameFedback',
getscormAssignedGame: '/scormgamePlay/getAssignedGames/',
getscormLeaderboardData: '/scormgamePlay/getLeaderboardData/',
getScorm: '/scormdetails/getScorm',
track_Api: '/scormdetails/track_Api',
updatescormdetails:'/scormdetails/updateScoreAndStatus'
